    ...
    return (
        <Container className="py-5 mx-auto" style={{ maxWidth: "1000px" }}>
            <div className="p-4 rounded-2 border bg-body-tertiary mb-4 border border-secondary">
                <h1 className="text-center fs-3 mb-2" style={{color: "#33b9bdff"}}>Resultat</h1>
            </div>
                ...
                <div className="row g-0">
                    ...
                    <div className="col-md-6">
                        <Card.Body className="p-4 text-start">
                            <Card.Title className="fs-4 mt-3 mb-4 text-center" style={{color: "#33b9bdff"}}>{characterKey}</Card.Title>
                            <Card.Text className="fs-5" dangerouslySetInnerHTML={{ __html: characters[characterKey].text }}></Card.Text>
                        </Card.Body>
                    </div>
                </div>
            </Card>
            <Card className="border border-secondary-subtle">
                <Card.Body className="p-4 text-start">
                    <Card.Title className="fs-4 mt-3 mb-4 text-center" style={{color: "#33b9bdff"}}>Poängfördelning</Card.Title>
                    <Card.Text className="fs-5">Din ledarstil är en blandning av följande karaktärer. Klicka på någon för att läsa om dem.</Card.Text>
